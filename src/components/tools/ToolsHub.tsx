...
import { Baby, Activity, ClipboardList, BookHeart, Lock } from 'lucide-react';

type Tab = 'tracker' | 'kick' | 'symptoms' | 'feeding' | 'sleep' | 'diaper' | 'growth' | 'summary';

const PREGNANT_TABS: Tab[] = ['tracker', 'kick', 'symptoms', 'summary'];
const PARENT_TABS: Tab[] = ['feeding', 'sleep', 'diaper', 'growth', 'symptoms', 'summary'];
...
export function ToolsHub() {
  ...
  return (
    <div>
      ...
      {/* Tab content */}
      {tab === 'tracker' && <PregnancyTracker user={user} />}
      {tab === 'kick' && <KickCounter />}
      {tab === 'symptoms' && <BabyLogForm type="SYMPTOM" />}
      {tab === 'feeding' && <BabyLogForm type="FEED" />}
      {tab === 'sleep' && <BabyLogForm type="SLEEP" />}
      {tab === 'diaper' && <BabyLogForm type="DIAPER" />}
      {tab === 'growth' && <BabyLogForm type="GROWTH" />}
...
const PREVIEW_TOOLS = [
  {
    ...
    description: 'Track your week-by-week progress, symptoms, and milestones from conception to birth.',
    color: '#8B1A2B',
  ...
  },
  {
    ...
    title: 'Kick Counter',
    description: 'Count and log foetal movements with timestamps to share with your midwife or OB.',
    color: '#C9A84C',
  ...
  },
  {
    ...
    title: 'Baby Log',
    description: 'After birth: log feeds, sleep, diapers, and growth milestones all in one place.',
    color: '#C9A84C',
    bg: 'rgba(201,168,76,0.08)',
    border: 'rgba(201,168,76,0.25)',
  },
...
function ToolsPreview() {
  return (
    <div className="max-w-2xl mx-auto">
      ...
      >
        <div className="px-8 py-8 text-center text-white">
          ...
          <p className="text-sm mb-6" style={{ color: 'rgba(255,255,255,0.75)' }}>
            Track your pregnancy, log symptoms, count kicks, and monitor your newborn — all in one place.
          </p>
          <Link
            href="/sign-in"
      ...
      <p
        className="text-xs font-bold uppercase tracking-[0.14em] mb-4 flex items-center gap-1.5"
        style={{ color: '#A88C3A' }}
      >
        ...
        {PREVIEW_TOOLS.map((tool) => (
          ...
          >
            ...
            <div className="absolute inset-0 backdrop-blur-[1px] flex flex-col items-center justify-end pb-4 z-10">
              <span
                ...
                style={{
                  ...
                  color: '#8B1A2B',
                  borderColor: 'rgba(139,26,43,0.2)',
                }}
              >
            ...
            <div className="p-5 select-none pointer-events-none">
              ...
              <h3
                className="font-serif text-base mb-1.5 leading-snug"
